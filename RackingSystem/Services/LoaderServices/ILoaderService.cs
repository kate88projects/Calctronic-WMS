...
namespace RackingSystem.Services.LoaderServices
{
    public interface ILoaderService
    {
        ...
        public Task<ServiceResponseModel<List<LoaderColumnDTO>>> GetLoaderColumnList();
        public Task<ServiceResponseModel<LoaderColumnDTO>> SaveLoaderColumn(LoaderColumnDTO loaderCol);
    }
}
