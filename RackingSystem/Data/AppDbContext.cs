...
namespace RackingSystem.Data
{
    public class AppDbContext : IdentityDbContext<User>
    {
        ...
        public DbSet<RackJob.RackJob> RackJob { get; set; }
        public DbSet<RackJobLog> RackJobLog { get; set; }
        public DbSet<RackJobReport> RackJobReport { get; set; }        
        ...
        public DbSet<PLCAddressResponseLog> PLCAddressResponseLog { get; set; }
